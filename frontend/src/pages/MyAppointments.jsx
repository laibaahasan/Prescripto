...
const MyAppointments = () => {
  ...
  return (
    <div>
      <p className='pb-3 mt-12 front-medium text-zinc-800 border-b'>My Appointments</p>
      <div>
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_3fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              {!item.cancelled && item.payment && <button className='sm:min-w-48 py-2 border rounded text-green-700 border-green-600 bg-green-200'>Paid</button>}
              ...
              {item.cancelled && <button className='sm:min-w-48 py-2 border border-red-500 rounded text-red-600 bg-red-100'>Appointment Cancelled</button>}
            </div>
