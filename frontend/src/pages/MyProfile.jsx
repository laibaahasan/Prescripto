...
const MyProfile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='font-medium' >Address:</p>{
             isEdit
             ?<p>
              <input className='bg-gray-50' typr="text"   onChange={e => setUserData(prev=>({...prev,address: {...prev.address, line1: e.target.value } }))} value={userData.address.line1} />
              <br/>
      ...
      {
        isEdit
       ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition' onClick={updateUserProfileData }>Save Information</button>
