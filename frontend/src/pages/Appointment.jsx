    ...
    <div >
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* doctor info-name,degre.. */}
          <p className='flex items-center gap-2 text-2xl font-medium'> {docInfo.name}  <img src={assets.verified_icon} alt="" />
          </p>
          <div>
      ...
      {/* BOOKING SLOTS */}
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-grat-700'>
        <p>Booking Slots</p>
